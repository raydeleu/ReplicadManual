...
```
The `edgeSelectionMethod` can be a combination of one or more selection methods as described in the previous section. If the edge selection is omitted, Replicad will try to round all edges of the object. 
