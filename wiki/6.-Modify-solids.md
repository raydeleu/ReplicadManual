...
``` javascript
 let rounded box = box.fillet(radius,(e)=>e.edgeSelectingMethod) 
```
The `edgeSelectionMethod` can be a combination of one or more selection methods as described in the previous section. 
