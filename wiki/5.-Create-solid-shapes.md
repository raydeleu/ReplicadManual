...
The Tinkercad application (see https://tinkercad.com) demonstrates that quite complicated structures can be built using a combination of simple shapes. The screenshot below shows the basic solids that are available in Tinkercad. Apart from the box, cylinder and sphere there are shapes like half domes, piramids, extruded hexagons, donuts et cetera.  

![tinkercad-shapes](https://github.com/raydeleu/ReplicadManual/assets/38007983/9d36ab08-a309-4aaa-baba-939301126bea)
