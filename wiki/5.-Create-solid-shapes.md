...
![tinkercad-shapes](https://github.com/raydeleu/ReplicadManual/assets/38007983/06949b26-e57b-4876-a6c3-847dfa599a72)

Most of these shapes can be created easily with the methods described in this chapter. If you want to use these shapes as quick building blocks, automating the creation of these shapes using functions will allow you to re-use these components. This will be discussed in Chapter [[9. Automate modelling with functions]]. 
