...
| `splineconfig = {startTangent:angle,endTangent:angle / "symmetric"} | configuration of spline points| 
...
| sketchRoundedRectangle(length,width,fillet,{plane:"XY",origin:dist/[point]})  | create a sketch of a rounded rectangle 
