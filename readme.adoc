...
A model in Replicad is built using a javascript input file (see Section <<File Template>>). The best way for a beginner is to use the studio tools which come in two flavours namely
