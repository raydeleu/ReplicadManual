...
let fill_hole  = Translate([-25,0,130],Rotate([0,1,0],-25,(Circle(12,true))));
let bottom = Translate([0,0,95],(Circle(8,true))); 
...
let plunge = Union([body,filler]);
plunge = FilletEdges(plunge,25,[5]);
