...
// show profile
let section = new Sketcher("XY",[0,0])
.movePointerTo([segmentHeight,-20])
.lineTo([segmentHeight,-16])
.threePointsArcTo([segmentHeight,16],[0,0])
.lineTo([segmentHeight,20])
...
sideView = sideView.fillet(5,(e)=>e.containsPoint([16,0,32-segmentHeight]))
sideView = sideView.fillet(5,(e)=>e.containsPoint([-16,0,32-segmentHeight]))
...
sideView = sideView.shell(-3,(f)=>f.containsPoint([0,0,0]))
...
stem = stem.fillet(1.0,(e)=>e.inPlane("XY",4))
...
sideView  = sideView.fillet(0.7,(e)=>e.inBox([-29,-29,3],[29,29,20]));
// sideView  = sideView.fillet(1.0,(e)=>e.atAngleWith("YZ",0));
// sideView  = sideView.fillet(1.0,(e)=>e.inPlane("XY",4).ofCurveType("CIRCLE"));
// sideView  = sideView.fillet(1.0,(e)=>e.parallelTo("XY"));

// sideView  = sideView.fillet(0.5);

// display the resulting shapes
let shapeArray = [
{shape: sideView, name: "sideView", color: "slategrey", opacity: 1.0},
// {shape: profileCut, name:"profileCut", color: "lightsteelblue", opacity: 0.7}, 
// {shape: section, name: "profile", color: "red"}
]; 

// return shapeArray
return prettyProjection(sideView);
