...
squircle=squircle.sketchOnPlane("XY").extrude(6)
roundedRectangle=roundedRectangle.sketchOnPlane("XY").extrude(3)
smoothSpline=smoothSpline.sketchOnPlane("XY").extrude(9)

return [
  {shape: squircle, color:"blue"},
  {shape: roundedRectangle,color:"red"},
  {shape: smoothSpline, color: "purple"}
]}